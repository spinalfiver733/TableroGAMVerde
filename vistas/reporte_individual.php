  ...
  <body>
     <div class="nav">
         <div class="row">
            ...
            <div class="col-md-4">
                  <button style="width:100%;height:50px;background-image: linear-gradient(#98989A, #9F2241);" class="btn"><a href="reporte_lista.php" style="color:white;"><li class="fa fa-list">  REPORTE POR LIDER</li></a></button>
...
<form action="reporte_individual.php" method="GET">
  <div align="center">                        
      <span class="input-group-text" id="basic-addon1" style="background-color:#9F2241;color:white;border-radius: 5px;font-size:1.3em;">    Seleccione un lider del siguiente menﾃｺ:
...
?>
        ...
        var options = {
          title: 'GRﾃ：ICA GENERAL DE AMBAS CANDIDATAS POR LIDER'
        };
