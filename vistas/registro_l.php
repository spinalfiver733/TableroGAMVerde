                 ...
                 <div class="main-box-body clearfix" >
                    <div class="col-sm-12">
                        <div class="small-box bg-aqua">
                            ...
                            <div class="inner">
                                 <h1 style="text-align:center;font-family:montserrat;color:#9F2241;background-color:white;border-radius:20px;"><strong>Tablero de control de lideres territoriales maderenses 2024</strong></h1>      
                                

                                
                                
                            <form action="cargar_l.php" method="POST" enctype="multipart/form-data" style="background-image: url('img/patron_g.png');width:100%;">   
                                ...
                                <br><br>
                                    ...
                                    <div class="col-md-12" style="width:100%;">
                                        <td style="float:center;width:100%;"><h2 style="color:#9F2241;font-family:montserrat;"><strong>Tipo de actividad: </strong></h2></td>
                                        <td style="float:center;width:100%;">                                
                                            <select name="act" style="font-size:1.5em;width:300px;">
                                                  <option value="APOYO" style="color:black;">ASAMBLEA</option>
                                        ...
                                        <div style="float:center;"><h2 style="color:#9F2241;"><strong>Tema: </strong></h2>                            
                                            <select name="tema" style="font-size:1.5em;width:300px;">
                                                  <option value="ALIMENTICIO" style="color:black;">SEGURIDAD</option>
                                        ...
                                        <div class="container" style="width:100%;">
                                            <h2 style="color:#9F2241;"><strong> Territorial y colonia: </strong></h2>                               
                                            <select name="colonia"  style="font-size:1em;width:300px;">
                                                    <?php  
                                    ...
                                    <tr>
                                        <td style="float:center;"><h2 style="color:#9F2241;"><strong> Beneficiarios: </strong></h2></td>
                                        <td style="float:left;">                                
                                          <input type="number" name="ben" style="color:black;font-size:1.5em;width:300px;">
                                        </td>
                                    </tr>      
                                    
                                       <tr>
                                        <td style="float:center;"><h2 style="color:#9F2241;"><strong> Monto: </strong></h2></td>
                                        <td style="float:left;">                                
                                          <input type="number" name="monto" style="color:black;font-size:1.5em;width:300px;">
                                        </td>
                                    </tr> 
                                ...
                                <div class="col-md-4"></div>
                                    ...
                                    <div class="col-md-4">
                                        <td style="float:center;"><h2 style="color:#9F2241;font-family:montserrat;width:300px;"><strong> Carga una evidencia: </strong></h2></td>                                        
                                        <td style="float:center;">
                                         <input type="file" name="foto" style="background-image: url('img/cinto.png');height:80px;border-radius:20px;width:300px;">     
                                        </td>
                                    </div>
