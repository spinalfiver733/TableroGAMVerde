...
$sql_fetch_todos = "SELECT * FROM datos_lideres order by id DESC";
            ...
            <tbody class="contenidobusqueda">
                ...
                while ($row = mysqli_fetch_array($query)) { ?>
                    <tr style="font-size:1.2em;color:black;background-image: url('img/patron_g.png');background-color:#f1eae8;">
                        ...
                        <td>
                        <a target="_blank" class="boton fa fa-eye btn" href="ver_evidencia_l.php?id=<?php echo $row['id'];?>" role="button" style="color:white;background-image: url('img/cinto.png');border-radius:15px;">
                                EVIDENCIA
                            </a>
                        <a class="boton fa fa-map-marker btn" href="mapeo_l.php?id=<?php echo $row['id'];?>" role="button" style="color:white;background-image: url('img/cinto.png');border-radius:15px;">
                                MAPEAR
                            </a>
