...
$lon = $_POST['lon'];
    ...
    if ($foto != "") {
        ...
        $sql = "INSERT INTO datos_jefes (cveut,nombre,fecha,hora,act,colonia,tema,ben,monto,lat,lon,icon,foto) VALUES ('$cveut','$nombre','$fecha','$hora','$act','$colonia','$tema','$ben','$monto','$lat','$lon','$icon','$foto')";
        ...
        if($conexion->query($sql)){
            ...
            header("Refresh:0 , url = lista_t.php");
            exit();
