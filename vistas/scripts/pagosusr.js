...
//Funcion que se ejecuta al inicio
        ...
        function listar() {
            tabla = $('#tbllistado').dataTable({
                ...
                "ajax": {
                    url: '../ajax/pagosusr.php?op=listar',
                    type: "get",
                    dataType: "json",
                    error: function (e) {
		...
		$("#imagenmuestra").show();
		$("#imagenmuestra").attr("src","../files/comprobantes/"+data.imagen);
...
function invalidar(idpago) {
    bootbox.confirm("¿Está Seguro invalidar el pago?", function (result) {
        if (result) {
            $.post("../ajax/pagos.php?op=invalidar", 
            {idpago: idpago }, function (e) {
                bootbox.alert(e);
                tabla.ajax.reload();
            });
        }
...
function validar(idpago) {
    bootbox.confirm("¿Está Seguro de validar el pago?", function (result) {
        if (result) {
            $.post("../ajax/pagos.php?op=validar", {
                idpago: idpago
            }, function (e) {
                bootbox.alert(e);
                tabla.ajax.reload();
