...
function initMap() {
    ...
    var markers = [
        ...
        $id = $_GET['id'];
                ...
                $result = $conexion->query("SELECT id,colonia,lat,lon,icon FROM datos_lideres where id = '$id'"); 
...
$result2 = $conexion->query("SELECT colonia,ben,hora,id,foto FROM datos_lideres where id = '$id'"); 
